...
public class BinV2 {
   ...
   public static void main(String[] args) {
      ...
      while(true) {
       ...
       if(number1.size()==64) {
          String t;
          t=complement(number1);
//          System.out.println("123"+t);
          number1.clear();
          for(int i=0;i<t.length();i++)
             number1.add(t.charAt(i)-'0');
          chk1=1;
       }
       
       for(int i=0;i<number1.size();i++)
          System.out.print(number1.get(number1.size()-i-1));
       System.out.println();      
       ...
       if(number2.size()==64) {
          String t;
          t=complement(number2);
          number2.clear();
          for(int i=0;i<t.length();i++)
             number2.add(t.charAt(i)-'0');
          chk2=1;
       }
       
       for(int i=0;i<number2.size();i++)
          System.out.print(number2.get(number2.size()-i-1));
       System.out.println();
      ...
      int size= result.size();
       ...
       num1="";
        ...
        System.out.println("당신은 상위 "+String.format("%.4f",topPer*100)+" %입니다");
   ...
   public static String BinMul(String num1, String num2){
            ...
            ArrayList<Integer> number2 = new ArrayList<Integer>();   //num2를 받을 ArrayList
             ...
             for(int i = 0; i < num2.length(); i++) //num2를 number2 배열에 1의자리 수부터 넣음 
               ...
               for(int i=0; i < lengthOfNumber2 ; i++)
               {
                  ...
                  finalResult = BinAdd(finalResult, subResult); 
               }      
      ...
      public static String BinAdd(String num1,String num2) {
      ...
      public static String mul(String num1, String num2){      //곱셈
           if(num1.equals("0") || num2.equals("0"))
              return "0";
               ...
               for(int i = 0; i < num1.length(); i++) //num1을 number1 배열에 1의자리 수부터 넣음 
                ...
                for(int i = 0; i < num2.length(); i++) //num2를 number2 배열에 1의자리 수부터 넣음 
                  ...
                  for(int i=0; i < num2.length() ; i++)
                  {
                     ...
                     finalResult = add(finalResult, subResult);
                  }
         ...
         public static String add(String num1,String num2) {
             ...
             number1.add(0); number2.add(0);    //최고 자리수에 올림수가 발생할수도 있으므로 0 추가
         ...
         public static String complement(ArrayList<Integer> num) {
