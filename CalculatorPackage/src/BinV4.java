      ...
      int size= result.size();
       ...
       //10진수 계산@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ 
         ...
         while(true) {
          ...
          if(operator.equals("+")) {
             if(flag==1) {
                if(chk1==1) s=sub(num2,s);
                else s=add(s,num2,chk1);
             }
             else {
                if(chk1==1) s=sub(num2,num1);
                else s=add(num1,num2,chk1);
             }
          }
              
           else if(operator.equals("-")) {
              if(flag==1) {
                 if(chk1==1) s=add(s,num2,chk1);
                 else s=sub(s,num2);
              }
              else {
                 if(chk1==1) s=add(num1,num2,chk1);
                 else s=sub(num1,num2);
              }
           }
        ...
        System.out.println("당신은 상위 "+String.format("%.4f",topPer)+" %입니다");
...
//                  
//                       for(int i=0;i<size;i++) {
//                          if(number2_complement.get(size-i-1)==0) {
//                             number2_complement.remove(size-i-1);
//                          }
//                          else 
//                             break;
//                          
...
//                     }
//                       for(int i=0;i<number2_complement.size();i++) {
//                          s+=number2_complement.get(number2_complement.size()-i-1);
//                       }
...
//                      for(int i=number2_complement.size()-1;i>=0;i++) {  //음수->양수로 바꾸ㅏ면서 0이 나오는 것을 제거해줌
//                      if(number2_complement.get(i)==0) {
//                    	  number2_complement.remove(i);
//                      }
//                      }
